...
$email_headertop = '
    <div class="emailpaged" style="background: #f6f6f6;background-image: url('.emailbg.');-webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;background-size: cover;background-position: center center;background-repeat: no-repeat;">
        <div class="emailcontent" style="width:100%;max-width:720px;text-align: left;margin: 0 auto;padding-top: 80px;padding-bottom: 20px">
            <div class="emailtitle" style="box-shadow: 0 5px 10px 0 rgba(160,160,160,.1);">
