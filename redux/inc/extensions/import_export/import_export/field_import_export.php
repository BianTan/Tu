    ...
    if ( ! class_exists( 'ReduxFramework_import_export' ) ) {
        ...
        class ReduxFramework_import_export extends ReduxFramework {
            ...
            public function render() {
                ...
                ?>
                    <h4><?php esc_html_e( '导入设置', 'redux-framework' ); ?></h4>

                    <p>
                        <a href="javascript:void(0);" id="redux-import-code-button" class="button-secondary">
                            <?php esc_html_e( '从文件导入', 'redux-framework' ); ?>
                        </a> 
                        <a href="javascript:void(0);" id="redux-import-link-button" class="button-secondary">
                            <?php esc_html_e( '从URL导入', 'redux-framework' ) ?>
                        </a>
                    </p>

                    <div id="redux-import-code-wrapper">
                        <p class="description" id="import-code-description">
                            <?php echo esc_html( apply_filters( 'redux-import-file-description', __( '在下方输入你备份文件中的文本内容，点击导入按钮即可导入备份中的设置', 'redux-framework' ) ) ); ?>
                        </p>
                    ...
                    <div id="redux-import-link-wrapper">
                        <p class="description" id="import-link-description"><?php echo esc_html( apply_filters( 'redux-import-link-description', __( '在下方输入备份网址URL，点击导入按钮即可导入网址URL中的设置', 'redux-framework' ) ) ); ?></p>
                        <?php // $this->parent->args['opt_name'] is sanitized in the ReduxFramework class, no need to re-sanitize it. ?>
                    ...
                    <p id="redux-import-action"><input type="submit" id="redux-import" name="import" class="button-primary" value="<?php esc_html_e( '导入', 'redux-framework' ) ?>">&nbsp;&nbsp;<span><?php echo esc_html( apply_filters( 'redux-import-warning', __( '警告! 该操作会覆盖原有的主题设置项, 请谨慎选择!', 'redux-framework' ) ) ) ?></span></p>

                    <div class="hr"/>
                    <div class="inner"><span>&nbsp;</span></div></div>
                    <h4><?php esc_html_e( '导出设置', 'redux-framework' ) ?></h4>

                    <div class="redux-section-desc">
                        <p class="description">
                            <?php echo esc_html( apply_filters( 'redux-backup-description', __( '此处你可以复制/下载备份设置数据，确保备份安全或者你可以将它保存在一个在线网站上', 'redux-framework' ) ) ) ?>
                        </p>
                    </div>
                <?php
                ...
                ?>
                    <p>
                        <a href="javascript:void(0);" id="redux-export-code-copy" class="button-secondary"><?php esc_html_e( '复制备份数据文本', 'redux-framework' ) ?></a>
                        <a href="<?php echo $link; ?>" id="redux-export-code-dl" class="button-primary"><?php esc_html_e( '下载备份数据文件', 'redux-framework' ) ?></a>
                        <a href="javascript:void(0);" id="redux-export-link" class="button-secondary"><?php esc_html_e( '复制备份链接', 'redux-framework' ) ?></a>
                    </p>
