...
if ( ! class_exists( 'ReduxFramework_media' ) ) {
    ...
    class ReduxFramework_media {
        ...
        public function render() {
            ...
            echo '<span class="button media_upload_button" id="' . $this->field['id'] . '-media">' . __( '上传', 'redux-framework' ) . '</span>';
            ...
            echo '<span class="button remove-image' . $hide . '" id="reset_' . $this->field['id'] . '" rel="' . $this->field['id'] . '">' . __( '移除', 'redux-framework' ) . '</span>';
