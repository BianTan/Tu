...
if ( ! class_exists( 'ReduxFramework_gallery' ) ) {
    ...
    class ReduxFramework_gallery {
        ...
        public function render() {
            ...
            echo '</div>';
            echo '<a href="#" onclick="return false;" id="edit-gallery" class="gallery-attachments button button-primary">' . __( '新增/编辑 相册', 'redux-framework' ) . '</a> ';
            echo '<a href="#" onclick="return false;" id="clear-gallery" class="gallery-attachments button">' . __( '清除相册', 'redux-framework' ) . '</a>';
