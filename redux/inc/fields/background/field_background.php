        ...
        class ReduxFramework_background {
            ...
            public function render() {
                ...
                if ( $this->field['background-image'] === true ) {
                    ...
                    echo '<span class="button redux-background-upload" id="' . $this->field['id'] . '-media">' . __( '上传', 'redux-framework' ) . '</span>';
                    ...
                    echo '<span class="button removeCSS redux-remove-background' . $hide . '" id="reset_' . $this->field['id'] . '" rel="' . $this->field['id'] . '">' . __( '移除', 'redux-framework' ) . '</span>';
