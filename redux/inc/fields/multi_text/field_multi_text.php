...
if ( ! class_exists( 'ReduxFramework_multi_text' ) ) {
    ...
    class ReduxFramework_multi_text {
        ...
        public function render() {
            ...
            $this->add_text   = ( isset( $this->field['add_text'] ) ) ? $this->field['add_text'] : __( '新增一个', 'redux-framework' );
            ...
            if ( isset( $this->value ) && is_array( $this->value ) ) {
                foreach ( $this->value as $k => $value ) {
                    if ( $value != '' || ($value == '' && $this->show_empty == true) ) {
                        ...
                        echo     '<a' . ' data-id="' . $this->field['id'] . '-ul" href="javascript:void(0);" class="deletion redux-multi-text-remove">' . __( '移除', 'redux-framework' ) . '</a>';
                        echo '</li>';
                    }
                }
